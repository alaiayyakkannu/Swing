...
/************************************/  
public class Exp188  implements ActionListener, MenuConstants  
{  
...
{  
if(Exp188.this.ta.getText().length()==0)  
    return; // text box have no text  
if(findReplaceDialog==null)  
    findReplaceDialog=new FindDialog(Exp188.this.ta);  
findReplaceDialog.showDialog(Exp188.this.f,true);//find  
}  
////////////////////////////////////  
...
if(findReplaceDialog==null)  
    findReplaceDialog=new FindDialog(Exp188.this.ta);  
findReplaceDialog.showDialog(Exp188.this.f,false);//replace  
}  
////////////////////////////////////  
...
if(fontDialog.showDialog(Exp188.this.f,"Choose a font"))  
	Exp188.this.ta.setFont(fontDialog.createFont());  
}  
////////////////////////////////////  
...
{  
JOptionPane.showMessageDialog(Exp188.this.f,aboutText,"Dedicated 2 u!",  
JOptionPane.INFORMATION_MESSAGE);  
}  
else  
...
if(backgroundDialog==null)  
    backgroundDialog=JColorChooser.createDialog  
        ...
        {public void actionPerformed(ActionEvent evvv){  
        	Exp188.this.ta.setBackground(bcolorChooser.getColor());}},  
        null);        
...
if(foregroundDialog==null)  
    foregroundDialog=JColorChooser.createDialog  
        ...
        new ActionListener()  
        {public void actionPerformed(ActionEvent evvv){  
        	Exp188.this.ta.setForeground(fcolorChooser.getColor());}},  
        null);        
...
{  
   public void menuSelected(MenuEvent evvvv)  
    ...
    if(Exp188.this.ta.getSelectionStart()==ta.getSelectionEnd())  
    {  
